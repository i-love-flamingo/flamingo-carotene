        ...
        if (this.domElement) {
          ...
          if (milliseconds > 0) {
            this.messageTimeout = setTimeout(function (_) {
              if (_this.displayPosition === 'bottom') {
                _this.domElement.style.transform = 'translateY(100%)';
              }

              if (_this.displayPosition === 'top') {
                _this.domElement.style.transform = 'translateY(-100%)';
              }

              _this.domElementCaroteneButton.style.transform = 'scale(1)';
            }, milliseconds);
          }
        }
      }
